...
# ── RSS-nyhedsfeeds (gratis, ingen API-nøgle kræves) ─────────────────────────
RSS_FEEDS = [
    {
...
# ── Virksomhedsnavne → ticker (til nyhedskobling) ────────────────────────────
COMPANY_ALIASES = {
    ...
    "walmart": "WMT", "costco": "COST", "mcdonald": "MCD",
    "coca-cola": "KO", "pepsi": "PEP", "pepsico": "PEP",
    "boeing": "BA", "caterpillar": "CAT",
    "disney": "DIS", "netflix": "NFLX",
    "novo nordisk": "NOVO-B.CO", "maersk": "MAERSK-B.CO", "orsted": "ORSTED.CO",
    "openai": None, "anthropic": None,  # Ikke børsnoteret
}

# ── Sektorudløsere (nøgleord → berørte tickers) ───────────────────────────────
SECTOR_TRIGGERS = {
...
# ── Cache TTL (sekunder) ──────────────────────────────────────────────────────
CACHE_TTL_MARKET = 300   # 5 min for markedsdata
CACHE_TTL_NEWS   = 600   # 10 min for nyheder
